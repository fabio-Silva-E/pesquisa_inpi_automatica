...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1766591543);
user_pref("app.update.lastUpdateTime.background-update-timer", 1766591543);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1766591543);
user_pref("app.update.lastUpdateTime.region-update-timer", 1766591543);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1766591543);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1766591543);
user_pref("app.update.migrated.updateDir3.19E5B574E2C8F13C", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "d601266a-bbda-4890-ac87-57ac8db94e4c");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1766591513);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{c785cd0d-c0a9-4809-8a38-5118ee53d774}");
...
user_pref("browser.startup.lastColdStartupCheck", 1766591791);
...
user_pref("browser.uiCustomization.state", "{\"placements\":{\"widget-overflow-fixed-list\":[],\"unified-extensions-area\":[\"_e58d3966-3d76-4cd9-8552-1582fbc800c1_-browser-action\"],\"nav-bar\":[\"back-button\",\"forward-button\",\"stop-reload-button\",\"customizableui-special-spring1\",\"vertical-spacer\",\"urlbar-container\",\"customizableui-special-spring2\",\"downloads-button\",\"fxa-toolbar-menu-button\",\"unified-extensions-button\"],\"toolbar-menubar\":[\"menubar-items\"],\"TabsToolbar\":[\"firefox-view-button\",\"tabbrowser-tabs\",\"new-tab-button\",\"alltabs-button\"],\"vertical-tabs\":[],\"PersonalToolbar\":[\"personal-bookmarks\"]},\"seen\":[\"developer-button\",\"screenshot-button\",\"_e58d3966-3d76-4cd9-8552-1582fbc800c1_-browser-action\"],\"dirtyAreaCache\":[\"nav-bar\",\"vertical-tabs\",\"toolbar-menubar\",\"TabsToolbar\",\"PersonalToolbar\",\"unified-extensions-area\"],\"currentVersion\":23,\"newElementCount\":2}");
...
user_pref("captchadetection.lastSubmission", 1766591);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "d762e1bb-a733-4705-b0e4-2e1c53a49752");
user_pref("datareporting.dau.cachedUsageProfileID", "5e1cd307-d459-4d17-afee-e44a4fc0633e");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"1acf157d-0ae7-441a-87c4-2030f88fc3b8\",\"formautofill@mozilla.org\":\"a38aeec0-3a23-40a1-951e-e2b039cd508f\",\"ipp-activator@mozilla.com\":\"555ffc0d-847b-4ab8-8fc0-b0910d544eb9\",\"pictureinpicture@mozilla.org\":\"5c3c88aa-5ce8-4d5a-bffa-1f90030fbd87\",\"addons-search-detection@mozilla.com\":\"2db80582-7477-4614-8f5d-cc9fc2fea9e7\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"2be15be9-49a0-46bf-a9cd-9f45b16a1e82\",\"default-theme@mozilla.org\":\"d453c457-4ec8-4b24-a5f3-57fcdf106c97\",\"{e58d3966-3d76-4cd9-8552-1582fbc800c1}\":\"8bd799e1-23de-4e03-83eb-2b72cc5ea6bf\"}");
...
user_pref("gfx-shader-check.device-id", "0x9a68");
...
user_pref("nimbus.profileId", "d5e534d9-9e4a-46ff-8003-820af16a650b");
...
user_pref("sanity-test.device-id", "0x9a68");
...
user_pref("toolkit.profiles.storeID", "1e151d48");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1766591790);
